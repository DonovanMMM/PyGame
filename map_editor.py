...
for x in range(TILE_TYPES):
    img = pygame.image.load(f"images/assets/{x}.png").convert_alpha()
    img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
    img_list.append(img)

save_image = pygame.image.load("images/save_btn.png").convert_alpha()
load_image = pygame.image.load("images/load_btn.png").convert_alpha()
...
save_button = button.Button(SCREEN_WIDTH // 2, SCREEN_HEIGHT + LOWER_MARGIN - 50, save_image, 1)
load_button = button.Button(SCREEN_WIDTH // 2 + 200, SCREEN_HEIGHT + LOWER_MARGIN - 50, load_image, 1)
...
while run:
    ...
    draw_text("Press W or D to change level", font, WHITE, 10, SCREEN_HEIGHT + LOWER_MARGIN - 60)
